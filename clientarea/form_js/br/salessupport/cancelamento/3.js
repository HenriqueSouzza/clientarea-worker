    ...
    return {
        ...
        visible: function () {
            return !!form.product
                && HgZendeskFormValidation.isProduct(form.product.pid, [
                    HgProducts.CRIADOR_SITES_LOJA_ADDON,
                    HgProducts.CRIADOR_SITES_PESSOAL_ADDON,
                    HgProducts.CRIADOR_SITES_PROFISSIONAL_ADDON,
                ])
        },
        root: {
            name: 'salessupport',
        ...
        fields: [
            ...
            },
            {
                label: 'Sub-Categoria',
                type: 'select',
                depends: 'motivocancelamento3',
                options: [
                    {
                        name: 'Dificuldade na configuração dos produtos e serviços',
                        value: 1,
                        hidden: form.motivocancelamento3 && form.motivocancelamento3.value !== 1,
                    },
                    {
                    ...
                    },
                    {
                        ...
                        value: 3,
                        hidden: form.motivocancelamento3 && form.motivocancelamento3.value !== 2,
                    },
                    {
                    ...
                    },
                    {
                        ...
                        value: 5,
                        hidden: form.motivocancelamento3 && form.motivocancelamento3.value !== 4,
                    },
                    {
                    ...
                    },
                    {
                        ...
                        value: 8,
                        hidden: form.motivocancelamento3 && form.motivocancelamento3.value !== 5,
                    },
                    {
                    ...
                    },
                    {
                        name: 'Preço',
                        value: 12,
                        hidden: form.motivocancelamento3 && form.motivocancelamento3.value !== 6,
                    },
                    {
                        name: 'Suporte',
                        value: 13,
                    ...
                    },
                    {
                        ...
                        value: 16,
                        hidden: form.motivocancelamento3 && form.motivocancelamento3.value !== 7,
                    },
                    {
                ...
                visible: function() {
                    return form.motivocancelamento3
                        && form.motivocancelamento3.value !== 3
                        && form.motivocancelamento3.value !== 8
                }
            },
            {
